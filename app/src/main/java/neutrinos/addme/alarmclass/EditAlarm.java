...
import neutrinos.addme.utilities.DateTime;
import neutrinos.addme.alarmclass.Alaram;
import neutrinos.addme.alarmclass.Alarm;

import static neutrinos.addme.fragment.DashBoardActivity.alarmBean;
...
public class EditAlarm extends AppCompatActivity
{
 ...
 public static Integer[] defaultAlaramTones= {R.raw.ganpati_mantra,R.raw.om_namah_shivay_om,R.raw.gayatri_mantra};
  public static String [] defaultAlaramTonesName={"Ganapathi Mantra","Om Namah Shivay","Gayatri Mantra"};
  List<Alaram> setAlarmTone= new ArrayList<>();
  private Spinner nDefaultToneSpinner;
    // shared pref mode
    int PRIVATE_MODE = 0;
    ...
    public  static  int setSelectedTone=0;
  ...
  public void onCreate(Bundle bundle)
  {
    ...
    nDefaultToneSpinner = (Spinner)findViewById(R.id.alaramtone);
    ...
    ArrayAdapter aa = new ArrayAdapter(this,android.R.layout.simple_spinner_item,setAlarmTone);
    aa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    //Setting the ArrayAdapter data on the Spinner
    nDefaultToneSpinner.setAdapter(aa);
    updateButtons();
    upDateDefaultAlarmTone();
    nDefaultToneSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
        @Override
        public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
            int getSelectedAlarmTone=defaultAlaramTones[position];
            mAlarm.setAlaramToneIndex(getSelectedAlarmTone);
            setSelectedTone=position;
    ...
    private void getAlaramToneFromSP() {
       setAlarmTone= alarmBean;
    }

    private void upDateDefaultAlarmTone() {
    nDefaultToneSpinner.getSelectedItemPosition();
  }
