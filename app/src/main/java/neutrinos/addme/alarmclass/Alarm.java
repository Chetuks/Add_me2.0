...
public class Alarm implements Comparable<Alarm>
{
  ...
  private int mDays;
  private int alaramToneIndex;
  private int mAlaramToneIndex;
  ...
  public int getAlaramToneIndex() {
    return alaramToneIndex;
  }

  public void setAlaramToneIndex(int alaramToneIndex) {
    this.alaramToneIndex = alaramToneIndex;
    updateAlaramTone(alaramToneIndex);
  }
  ...
  public  void updateAlaramTone(int getAlaramTone){
    mAlaramToneIndex=getAlaramTone;
  ...
  public void toIntent(Intent intent)
  {
    ...
    intent.putExtra("com.taradov.alarmme.tone", mAlaramToneIndex);
  }
  ...
  public void fromIntent(Intent intent)
  {
    ...
    alaramToneIndex = intent.getIntExtra("com.taradov.alarmme.tone", R.raw.om_namah_shivay_om);
    update();
    updateAlaramTone(alaramToneIndex);
  }
