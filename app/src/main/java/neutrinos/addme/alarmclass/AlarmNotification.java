...
import static neutrinos.addme.alarmclass.EditAlarm.setSelectedTone;
...
public class AlarmNotification extends Activity
{
  ...
  private void start(Intent intent)
  {
    ...
    Alaram alaram=getSelectedAlaramTone();
    // mAlarmSound =  Uri.parse("android.resource://neutrinos.anandaguruji/" + mAlarm.getAlaramToneIndex());
    mAlarmSound =  Uri.parse(alaram.getUrl());
    // TODO  real content should remove this line
    //  mAlarmSound =  Uri.parse("android.resource://neutrinos.anandaguruji/" + R.raw.om_namah_shivay_om);
    mRingtone = RingtoneManager.getRingtone(getApplicationContext(), mAlarmSound);
  ...
  private Alaram getSelectedAlaramTone() {
    Alaram alaramTemp= new Alaram();
    if (!alarmBean.isEmpty())
      alaramTemp=alarmBean.get(setSelectedTone);
    return alaramTemp;
  }
