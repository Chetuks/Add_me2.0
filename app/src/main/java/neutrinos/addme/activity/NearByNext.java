...
public class NearByNext extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newdialog = new ProgressDialog(NearByNext.this);
        ...
        if (bundle != null) {
            ...
            gridModelClass = (NearbyModelClass) bundle.getSerializable("modelcalss");
            assert gridModelClass != null;
            String orgName=String.valueOf(gridModelClass.getOrganizationname());
            Picasso.get()
                    .load(gridModelClass.getContentImage())
                    .fit()
                    .into(offerimage);
    ...
    private String getDeviceId() {
        ...
        return Settings.Secure.getString(NearByNext.this.getContentResolver(),
                Settings.Secure.ANDROID_ID);
    }

    private void setUserListToServer(NearbyModelClass gridModelClass, int i) {
        if (gridModelClass != null) {
            ...
            Toast.makeText(NearByNext.this, "List is empty", Toast.LENGTH_SHORT).show();
        }
    }
    private void callFavouriteapi(final String s, final String test, JSONArray jsonStructure,
        ...
        Volley.newRequestQueue(NearByNext.this).add(postRequest);
    }
